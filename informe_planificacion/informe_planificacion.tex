...
\midrule
\rowcolor{tabrow}
Definición del problema y alcance   & R & A & A  \\
Organización y verificación de datos & A & R & A  \\
\rowcolor{tabrow}
Formulación de supuestos             & A & A & R  \\
Modelo conceptual del sistema        & R & A & R  \\
\rowcolor{tabrow}
Módulo demanda e inventario (SIMIO)  & R & A & I  \\
Módulo producción y RRHH (SIMIO)     & R & I & A  \\
\rowcolor{tabrow}
Módulo horno batch (SIMIO)           & R & I & A  \\
Políticas de secuenciamiento         & A & A & R  \\
\rowcolor{tabrow}
Verificación y validación            & R & A & A  \\
Diseño y ejecución de experimentos   & A & A & R  \\
\rowcolor{tabrow}
Análisis de sensibilidad             & A & R & A  \\
Informe técnico (gerencial)          & I & A & A  \\
\rowcolor{tabrow}
Informe académico                    & I & A & A  \\
\bottomrule
\end{tabularx}
\end{table}
